...
# 5 "/home/jinghanhui/ysyx-workbench/nemu/include/cpu/get_elf.h" 2
...
# 6 "/home/jinghanhui/ysyx-workbench/nemu/include/cpu/get_elf.h" 2
...
# 7 "/home/jinghanhui/ysyx-workbench/nemu/include/cpu/get_elf.h" 2
...
# 8 "/home/jinghanhui/ysyx-workbench/nemu/include/cpu/get_elf.h" 2
...
# 2 "src/cpu/get_elf.c" 2
FILE *elf_fileopen( char *filename) {
    FILE *fp=fopen(filename,"rb");
    if(fp==
# 4 "src/cpu/get_elf.c" 3 4
          ((void *)0)
# 4 "src/cpu/get_elf.c"
              ){
        printf("\033[1:34m""File:%s not found\n""\033[0m",filename);
        return 
# 6 "src/cpu/get_elf.c" 3 4
              ((void *)0)
# 6 "src/cpu/get_elf.c"
                  ;
    }
...
Elf32_Shdr * elf32_Shdr_read(FILE *fp, Elf32_Ehdr *ehdr) {
    ...
    if(fseek(fp, ehdr->e_shoff, 
# 30 "src/cpu/get_elf.c" 3 4
                               0
# 30 "src/cpu/get_elf.c"
                                       )){
        printf("\033[1;31m""shdr fseek error\n""\033[0m");
        return 
# 32 "src/cpu/get_elf.c" 3 4
              ((void *)0)
# 32 "src/cpu/get_elf.c"
                  ;
    }
    shdr_pointer = (Elf32_Shdr *)malloc(sizeof(Elf32_Shdr) * ehdr->e_shnum);
    if(shdr_pointer==
# 35 "src/cpu/get_elf.c" 3 4
                    ((void *)0)
# 35 "src/cpu/get_elf.c"
                        ){
        printf("\033[1;31m""shdr memory allocation error\n""\033[0m");
        return 
# 37 "src/cpu/get_elf.c" 3 4
              ((void *)0)
# 37 "src/cpu/get_elf.c"
                  ;
    }
    int read_size;
    ...
    if(read_size!=ehdr->e_shnum){
        ...
        return 
# 43 "src/cpu/get_elf.c" 3 4
              ((void *)0)
# 43 "src/cpu/get_elf.c"
                  ;
    }
    else{
        return shdr_pointer;
...
char *shstrtab_read(FILE *fp, Elf32_Shdr *shdr_pointer, Elf32_Ehdr *ehdr) {
    fseek(fp, shdr_pointer[ehdr->e_shstrndx].sh_offset, 
# 50 "src/cpu/get_elf.c" 3 4
                                                       0
# 50 "src/cpu/get_elf.c"
                                                               );
    ...
    if(fread(shstr, shdr_pointer[ehdr->e_shstrndx].sh_size, 1, fp) != 1) {
        ...
        return 
# 54 "src/cpu/get_elf.c" 3 4
              ((void *)0)
# 54 "src/cpu/get_elf.c"
                  ;
    }
    return shstr;
}
...
Elf32_Sym *symtab_read(FILE *fp, Elf32_Shdr *shdr_pointer, int symtab_index) {
    ...
    if(fseek(fp, shdr_pointer[symtab_index].sh_offset, 
# 68 "src/cpu/get_elf.c" 3 4
                                                      0
# 68 "src/cpu/get_elf.c"
                                                              )) {
        printf("\033[1;31m""symtab fseek error\n""\033[0m");
        return 
# 70 "src/cpu/get_elf.c" 3 4
              ((void *)0)
# 70 "src/cpu/get_elf.c"
                  ;
    }
    ...
    if(fread(symtab_pointer, shdr_pointer[symtab_index].sh_size, 1, fp) != 1) {
        ...
        return 
# 75 "src/cpu/get_elf.c" 3 4
              ((void *)0)
# 75 "src/cpu/get_elf.c"
                  ;
    }
...
char *strtab_read(FILE *fp, Elf32_Shdr *shdr_pointer, int strtab_index) {
    char *strtab;
    if(fseek(fp, shdr_pointer[strtab_index].sh_offset, 
# 92 "src/cpu/get_elf.c" 3 4
                                                      0
# 92 "src/cpu/get_elf.c"
                                                              )) {
        printf("\033[1;31m""strtab fseek error\n""\033[0m");
        return 
# 94 "src/cpu/get_elf.c" 3 4
              ((void *)0)
# 94 "src/cpu/get_elf.c"
                  ;
    }
    ...
    if(fread(strtab, shdr_pointer[strtab_index].sh_size, 1, fp) != 1) {
        ...
        return 
# 99 "src/cpu/get_elf.c" 3 4
              ((void *)0)
# 99 "src/cpu/get_elf.c"
                  ;
    }
    return strtab;
}
...
int sym_func_index_find( Elf32_Sym * symtab_pointer,uint32_t arr,int symlens){
    ...
    int flag=0;
    for(i=0;i<symlens;i++){
        if(arr>=symtab_pointer[i].st_value&&arr<symtab_pointer[i].st_value+symtab_pointer[i].st_size&&symtab_pointer[i].st_info==18){
            return i;
        }
    }
    if(flag==0){
...
void memory_free(Elf32_Shdr *shdr_pointer, Elf32_Sym *symtab_pointer, char *strtab,char *shstrtab) {
    if(shdr_pointer != 
# 124 "src/cpu/get_elf.c" 3 4
                      ((void *)0)
# 124 "src/cpu/get_elf.c"
                          ) {
    free(shdr_pointer);
    }
    if(symtab_pointer != 
# 127 "src/cpu/get_elf.c" 3 4
                        ((void *)0)
# 127 "src/cpu/get_elf.c"
                            ) {
    free(symtab_pointer);
    }
    if(strtab != 
# 130 "src/cpu/get_elf.c" 3 4
                ((void *)0)
# 130 "src/cpu/get_elf.c"
                    ) {
    free(strtab);
    }
    if(shstrtab != 
# 133 "src/cpu/get_elf.c" 3 4
                  ((void *)0)
# 133 "src/cpu/get_elf.c"
                      ) {
    free(shstrtab);
    }
}
...
void inst_print_funcname(Elf32_Shdr *shdr_pointer,char *strtab,Elf32_Sym *symtab_pointer,uint32_t inst,uint32_t dnpc ,uint32_t pc,int symlens,int *call_count){
    if(shdr_pointer==
# 151 "src/cpu/get_elf.c" 3 4
                    ((void *)0)
# 151 "src/cpu/get_elf.c"
                        ||strtab==
# 151 "src/cpu/get_elf.c" 3 4
                                  ((void *)0)
# 151 "src/cpu/get_elf.c"
