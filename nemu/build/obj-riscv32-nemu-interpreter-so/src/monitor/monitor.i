...
# 81 "src/monitor/monitor.c"
  ...
  do { printf("\33[1;34m" "[%s:%d %s] " "The image is %s, size = %ld" "\33[0m" "\n", "src/monitor/monitor.c", 84, __func__, img_file, size); ; } while (0);
