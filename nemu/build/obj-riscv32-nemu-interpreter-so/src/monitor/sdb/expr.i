...
# 23 "src/monitor/sdb/expr.c" 2

static word_t eval(int p,int q,
# 24 "src/monitor/sdb/expr.c" 3 4
                              _Bool 
# 24 "src/monitor/sdb/expr.c"
                                   *success);
static int check_parentheses(int p,int q,
# 25 "src/monitor/sdb/expr.c" 3 4
                                        _Bool 
# 25 "src/monitor/sdb/expr.c"
                                             *success);
...
# 72 "src/monitor/sdb/expr.c" 3 4
                                         1
# 72 "src/monitor/sdb/expr.c"
                                                     );
    if (ret != 0) {
      regerror(ret, &re[i], error_msg, 128);
      do { if (!(0)) { (fflush(
# 75 "src/monitor/sdb/expr.c" 3 4
     stdout
# 75 "src/monitor/sdb/expr.c"
     ), fprintf(
# 75 "src/monitor/sdb/expr.c" 3 4
     stderr
# 75 "src/monitor/sdb/expr.c"
...
# 75 "src/monitor/sdb/expr.c"
     "0"
# 75 "src/monitor/sdb/expr.c" 3 4
     , "src/monitor/sdb/expr.c", 75, __extension__ __PRETTY_FUNCTION__); }))
# 75 "src/monitor/sdb/expr.c"
     ; } } while (0);
    }
  }
...
static 
# 87 "src/monitor/sdb/expr.c" 3 4
      _Bool 
# 87 "src/monitor/sdb/expr.c"
           make_token(char *e) {
  word_t temp;
  int position = 0;
  
# 90 "src/monitor/sdb/expr.c" 3 4
 _Bool 
# 90 "src/monitor/sdb/expr.c"
      success=1;
  int i;
  regmatch_t pmatch;
  ...
  while (e[position] != '\0') {
   ...
   tokens[nr_token].type = rules[i].token_type;
    ...
    case TK_HEXNUM:
     strncpy(tokens[nr_token].str,substr_start,substr_len);
     tokens[nr_token].str[substr_len]='\0';
     temp=(word_t)strtoul(tokens[nr_token].str,
# 125 "src/monitor/sdb/expr.c" 3 4
                                              ((void *)0)
# 125 "src/monitor/sdb/expr.c"
                                                  ,16);
    ...
    case TK_REG:
     ...
     if(success==0)
      return 
# 134 "src/monitor/sdb/expr.c" 3 4
            0
# 134 "src/monitor/sdb/expr.c"
                 ;
     else{
      sprintf(tokens[nr_token].str,"%u",temp);
     }
   ...
   if(nr_token==2000){
    ...
    return 
# 157 "src/monitor/sdb/expr.c" 3 4
          0
# 157 "src/monitor/sdb/expr.c"
               ;
   }
        break;
      }
...
static int check_parentheses(int p,int q,
# 171 "src/monitor/sdb/expr.c" 3 4
                                        _Bool 
# 171 "src/monitor/sdb/expr.c"
                                             *success){
  int i;
  int left=0,right=0;
  if(tokens[p].type==')'){
   *success=
# 175 "src/monitor/sdb/expr.c" 3 4
           0
# 175 "src/monitor/sdb/expr.c"
                ;
   printf("There is a problem with the brackets\n");
   return 
# 177 "src/monitor/sdb/expr.c" 3 4
         0
# 177 "src/monitor/sdb/expr.c"
              ;
  }
     for(i=p;i<=q;i++){
   if(tokens[i].type=='(')
  ...
  if(left!=right){
   *success=
# 186 "src/monitor/sdb/expr.c" 3 4
           0
# 186 "src/monitor/sdb/expr.c"
                ;
   printf("There is a problem with the number of brackets\n");
   return 
# 188 "src/monitor/sdb/expr.c" 3 4
         0
# 188 "src/monitor/sdb/expr.c"
              ;
   }
  left=0;
  for(i=p;i<=q;i++){
...
# 197 "src/monitor/sdb/expr.c"
  ...
  if(tokens[p].type=='('&&left==0&&tokens[q].type==')')
   return 
# 203 "src/monitor/sdb/expr.c" 3 4
         1
# 203 "src/monitor/sdb/expr.c"
             ;
  else
   return 
# 205 "src/monitor/sdb/expr.c" 3 4
         0
# 205 "src/monitor/sdb/expr.c"
              ;
  if(left<0){*success=
# 206 "src/monitor/sdb/expr.c" 3 4
                     0
# 206 "src/monitor/sdb/expr.c"
                          ; return 
# 206 "src/monitor/sdb/expr.c" 3 4
                                   0
# 206 "src/monitor/sdb/expr.c"
...
static int findop(int p,int q){
  int i=0,op=0,parent=0,flag1=0,flag2=0,flag3=0;
  for(i=p;i<=q;i++){
   if(tokens[i].type=='(')
    parent++;
   if(tokens[i].type==')')
...
# 259 "src/monitor/sdb/expr.c"
 ...
 if(p>q){ *success=
# 260 "src/monitor/sdb/expr.c" 3 4
                  0
# 260 "src/monitor/sdb/expr.c"
                       ;return 0;}
    else if(p==q){
   if(tokens[p].type==TK_NUM)
    return (word_t)strtoul(tokens[p].str,
...
# 267 "src/monitor/sdb/expr.c" 3 4
                                        1
# 267 "src/monitor/sdb/expr.c"
                                            ){
...
# 311 "src/monitor/sdb/expr.c"
          "false"
# 311 "src/monitor/sdb/expr.c" 3 4
          , "src/monitor/sdb/expr.c", 311, __extension__ __PRETTY_FUNCTION__); }))
# 311 "src/monitor/sdb/expr.c"
                       ;
   }
 }
...
word_t expr(char *e, 
# 317 "src/monitor/sdb/expr.c" 3 4
                    _Bool 
# 317 "src/monitor/sdb/expr.c"
                         *success) {
 int i;
 *success=1;
  if (!make_token(e)) {
