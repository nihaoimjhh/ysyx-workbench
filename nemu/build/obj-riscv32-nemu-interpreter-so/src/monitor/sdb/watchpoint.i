...
# 27 "src/monitor/sdb/watchpoint.c"
static WP wp_pool[5] = {};
static WP *head = 
...
void init_wp_pool() {
  ...
  for (i = 0; i < 5; i ++) {
    wp_pool[i].NO = i;
    wp_pool[i].remove = 1;
    wp_pool[i].next = (i == 5 - 1 ? 
# 35 "src/monitor/sdb/watchpoint.c" 3 4
                                       ((void *)0) 
# 35 "src/monitor/sdb/watchpoint.c"
                                            : &wp_pool[i + 1]);
    wp_pool[i].expr[0]='\0';
  }
...
WP *new_wp(
# 42 "src/monitor/sdb/watchpoint.c" 3 4
          _Bool 
# 42 "src/monitor/sdb/watchpoint.c"
               *success){
  WP *freetemp=
# 43 "src/monitor/sdb/watchpoint.c" 3 4
              ((void *)0)
# 43 "src/monitor/sdb/watchpoint.c"
                  ;
  WP *headtemp=
...
# 44 "src/monitor/sdb/watchpoint.c"
                  ;
  if(free_==
# 45 "src/monitor/sdb/watchpoint.c" 3 4
           ((void *)0)
# 45 "src/monitor/sdb/watchpoint.c"
               ){
   *success=
...
# 46 "src/monitor/sdb/watchpoint.c"
   ...
   free_=free_->next;
   freetemp->next=
# 52 "src/monitor/sdb/watchpoint.c" 3 4
                 ((void *)0)
# 52 "src/monitor/sdb/watchpoint.c"
                     ;
   if(head==
...
# 53 "src/monitor/sdb/watchpoint.c"
   ...
   for(headtemp=head;headtemp->next!=
# 59 "src/monitor/sdb/watchpoint.c" 3 4
                                    ((void *)0)
# 59 "src/monitor/sdb/watchpoint.c"
...
WP *free_wp(WP *wp,
# 66 "src/monitor/sdb/watchpoint.c" 3 4
                  _Bool 
# 66 "src/monitor/sdb/watchpoint.c"
                       *success){
  WP *freetemp=
# 67 "src/monitor/sdb/watchpoint.c" 3 4
              ((void *)0)
# 67 "src/monitor/sdb/watchpoint.c"
                  ;
  WP *headtemp=
# 68 "src/monitor/sdb/watchpoint.c" 3 4
              ((void *)0)
# 68 "src/monitor/sdb/watchpoint.c"
                  ;
  if(wp==
# 69 "src/monitor/sdb/watchpoint.c" 3 4
        ((void *)0)
# 69 "src/monitor/sdb/watchpoint.c"
            ){
   *success=
# 70 "src/monitor/sdb/watchpoint.c" 3 4
           0
# 70 "src/monitor/sdb/watchpoint.c"
                ;
   return free_;
  }
  if(wp->remove==1){
...
# 74 "src/monitor/sdb/watchpoint.c"
   ...
   if(head==wp){
    ...
    head=head->next;
    headtemp->next=
# 83 "src/monitor/sdb/watchpoint.c" 3 4
                  ((void *)0)
# 83 "src/monitor/sdb/watchpoint.c"
                      ;
    if(free_==
# 84 "src/monitor/sdb/watchpoint.c" 3 4
             ((void *)0)
# 84 "src/monitor/sdb/watchpoint.c"
                 ){
     free_=headtemp;
     wp->remove=1;
    }
    else{
     for(freetemp=free_;freetemp->next!=
# 89 "src/monitor/sdb/watchpoint.c" 3 4
                                       ((void *)0)
# 89 "src/monitor/sdb/watchpoint.c"
                                           ;freetemp=freetemp->next){}
      freetemp->next=headtemp;
      wp->remove=1;
    }
   }
   else{
...
# 101 "src/monitor/sdb/watchpoint.c"
     ...
     for(freetemp=free_;freetemp->next!=
# 105 "src/monitor/sdb/watchpoint.c" 3 4
                                       ((void *)0)
# 105 "src/monitor/sdb/watchpoint.c"
                                           ;freetemp=freetemp->next){}
...
# 117 "src/monitor/sdb/watchpoint.c"
                                       *success){
  WP *headtemp=
# 118 "src/monitor/sdb/watchpoint.c" 3 4
              ((void *)0)
# 118 "src/monitor/sdb/watchpoint.c"
                  ;
...
# 132 "src/monitor/sdb/watchpoint.c" 3 4
 _Bool 
# 132 "src/monitor/sdb/watchpoint.c"
      success=
# 132 "src/monitor/sdb/watchpoint.c" 3 4
              1
# 132 "src/monitor/sdb/watchpoint.c"
...
# 182 "src/monitor/sdb/watchpoint.c" 3 4
 _Bool 
# 182 "src/monitor/sdb/watchpoint.c"
      success;
  for(i=0;i<5;i++){
