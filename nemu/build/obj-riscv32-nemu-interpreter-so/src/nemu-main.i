...
# 41 "src/nemu-main.c"
     ...
     if (fp == 
# 45 "src/nemu-main.c" 3 4
              ((void *)0)
# 45 "src/nemu-main.c"
                  ) {
         perror("fopen");
         
# 47 "src/nemu-main.c" 3 4
        ((void) sizeof ((
# 47 "src/nemu-main.c"
        0
# 47 "src/nemu-main.c" 3 4
...
# 47 "src/nemu-main.c"
        "0"
# 47 "src/nemu-main.c" 3 4
        , "src/nemu-main.c", 47, __extension__ __PRETTY_FUNCTION__); }))
# 47 "src/nemu-main.c"
                 ;
     }
     while (fgets(buffer, sizeof(buffer), fp) != 
# 49 "src/nemu-main.c" 3 4
                                                ((void *)0)
# 49 "src/nemu-main.c"
                                                    ) {
         uint32_t answer;
