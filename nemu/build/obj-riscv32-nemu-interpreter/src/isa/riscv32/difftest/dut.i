...
# 16 "src/isa/riscv32/difftest/dut.c"
...
# 17 "src/isa/riscv32/difftest/dut.c" 2
...
# 18 "src/isa/riscv32/difftest/dut.c" 2
# 1 "src/isa/riscv32/difftest/../local-include/reg.h" 1
# 21 "src/isa/riscv32/difftest/../local-include/reg.h"
static inline int check_reg_idx(int idx) {
  
# 22 "src/isa/riscv32/difftest/../local-include/reg.h" 3 4
 ((void) sizeof ((
# 22 "src/isa/riscv32/difftest/../local-include/reg.h"
 idx >= 0 && idx < 32
# 22 "src/isa/riscv32/difftest/../local-include/reg.h" 3 4
...
# 19 "src/isa/riscv32/difftest/dut.c" 2

# 19 "src/isa/riscv32/difftest/dut.c" 3 4
_Bool 
# 19 "src/isa/riscv32/difftest/dut.c"
    isa_difftest_checkregs(CPU_state *ref_r, vaddr_t pc) {
      for(int i=0;i<32;i++){
         if(ref_r->gpr[i]!=cpu.gpr[i]){
             printf("reg[%d] is different, ref is %x, dut is %x\n",i,ref_r->gpr[i],cpu.gpr[i]);
             return 
# 23 "src/isa/riscv32/difftest/dut.c" 3 4
                   0
# 23 "src/isa/riscv32/difftest/dut.c"
                        ;
         }
      }
      if(ref_r->pc!=cpu.pc){
          ...
          return 
# 28 "src/isa/riscv32/difftest/dut.c" 3 4
                0
# 28 "src/isa/riscv32/difftest/dut.c"
                     ;
      }
      else{
          return 
# 31 "src/isa/riscv32/difftest/dut.c" 3 4
                1
# 31 "src/isa/riscv32/difftest/dut.c"
                    ;
      }
}
void isa_difftest_attach() {
