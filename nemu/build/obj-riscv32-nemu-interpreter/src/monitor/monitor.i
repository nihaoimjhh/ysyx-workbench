...
# 1 "/home/jinghanhui/ysyx-workbench/nemu/include/memory/paddr.h" 1
# 26 "/home/jinghanhui/ysyx-workbench/nemu/include/memory/paddr.h"
uint8_t* guest_to_host(paddr_t paddr);

paddr_t host_to_guest(uint8_t *haddr);

static inline 
# 30 "/home/jinghanhui/ysyx-workbench/nemu/include/memory/paddr.h" 3 4
             _Bool 
# 30 "/home/jinghanhui/ysyx-workbench/nemu/include/memory/paddr.h"
...
# 79 "src/monitor/monitor.c"
 "fp"
# 79 "src/monitor/monitor.c" 3 4
 , "src/monitor/monitor.c", 79, __extension__ __PRETTY_FUNCTION__); }))
# 79 "src/monitor/monitor.c"
 ; } } while (0);
...
# 88 "src/monitor/monitor.c"
 "ret == 1"
# 88 "src/monitor/monitor.c" 3 4
 , "src/monitor/monitor.c", 88, __extension__ __PRETTY_FUNCTION__); }))
# 88 "src/monitor/monitor.c"
                 ;
...
void load_elf(char * elf_file){
    if (elf_file != 
# 94 "src/monitor/monitor.c" 3 4
                   ((void *)0)
# 94 "src/monitor/monitor.c"
                       ){
       fp = elf_fileopen(elf_file);

      if(fp==
# 97 "src/monitor/monitor.c" 3 4
            ((void *)0)
# 97 "src/monitor/monitor.c"
                ){
        ...
        fseek(fp, 0, 
# 123 "src/monitor/monitor.c" 3 4
                    2
# 123 "src/monitor/monitor.c"
                            );
        long size = ftell(fp);
        do { printf("\33[1;34m" "[%s:%d %s] " "The elf is %s, size = %ld" "\33[0m" "\n", "src/monitor/monitor.c", 125, __func__, elf_file, size); do { extern FILE* log_fp; extern 
# 125 "src/monitor/monitor.c" 3 4
       _Bool 
# 125 "src/monitor/monitor.c"
       log_enable(); if (log_enable()) { fprintf(log_fp, "\33[1;34m" "[%s:%d %s] " "The elf is %s, size = %ld" "\33[0m" "\n", "src/monitor/monitor.c", 125, __func__, elf_file, size); fflush(log_fp); } } while (0); } while (0);
        fclose(fp);
      }
    }
    else{
      do { printf("\33[1;34m" "[%s:%d %s] " "No elf_file is given." "\33[0m" "\n", "src/monitor/monitor.c", 130, __func__); do { extern FILE* log_fp; extern 
# 130 "src/monitor/monitor.c" 3 4
     _Bool 
# 130 "src/monitor/monitor.c"
     log_enable(); if (log_enable()) { fprintf(log_fp, "\33[1;34m" "[%s:%d %s] " "No elf_file is given." "\33[0m" "\n", "src/monitor/monitor.c", 130, __func__); fflush(log_fp); } } while (0); } while (0);
    }
}
...
# 139 "src/monitor/monitor.c"
                                        , 'h'},
    {"elf_file" , 
# 140 "src/monitor/monitor.c" 3 4
                 1
# 140 "src/monitor/monitor.c"
                                  , 
# 140 "src/monitor/monitor.c" 3 4
                                    ((void *)0)
# 140 "src/monitor/monitor.c"
...
# 144 "src/monitor/monitor.c" 3 4
                                                            ((void *)0)
# 144 "src/monitor/monitor.c"
                                                                )) != -1) {
    switch (o) {
