...
word_t expr(char *e, 
# 30 "src/monitor/sdb/sdb.h" 3 4
                    _Bool 
# 30 "src/monitor/sdb/sdb.h"
                         *success);
WP *wp_creat(char *args,word_t ans,
# 31 "src/monitor/sdb/sdb.h" 3 4
                                  _Bool 
# 31 "src/monitor/sdb/sdb.h"
                                       *success);
WP *free_wp(WP *wp,
# 32 "src/monitor/sdb/sdb.h" 3 4
                  _Bool 
# 32 "src/monitor/sdb/sdb.h"
                       *success);
void wp_print();
...
# 22 "src/monitor/sdb/sdb.c" 2

static int is_batch_mode = 
# 23 "src/monitor/sdb/sdb.c" 3 4
                          0
# 23 "src/monitor/sdb/sdb.c"
                               ;
...
# 30 "src/monitor/sdb/sdb.c" 3 4
                          ((void *)0)
# 30 "src/monitor/sdb/sdb.c"
                              ;

  if (line_read) {
    free(line_read);
    line_read = 
# 34 "src/monitor/sdb/sdb.c" 3 4
               ((void *)0)
# 34 "src/monitor/sdb/sdb.c"
                   ;
  }
...
static int cmd_si(char *args) {
 ...
 if(args==
# 59 "src/monitor/sdb/sdb.c" 3 4
         ((void *)0)
# 59 "src/monitor/sdb/sdb.c"
             ){
   n=1;
  }
 else{
...
static int cmd_info(char *args) {
  if(args==
# 71 "src/monitor/sdb/sdb.c" 3 4
          ((void *)0)
# 71 "src/monitor/sdb/sdb.c"
...
# 84 "src/monitor/sdb/sdb.c" 3 4
 _Bool 
# 84 "src/monitor/sdb/sdb.c"
      success=
# 84 "src/monitor/sdb/sdb.c" 3 4
              1
# 84 "src/monitor/sdb/sdb.c"
                  ;
  if(args==
# 85 "src/monitor/sdb/sdb.c" 3 4
          ((void *)0)
# 85 "src/monitor/sdb/sdb.c"
              ) {printf("Please enter the number N to be printed and which address EXPR\nexample: x 10 0x80000000 or x 10 $reg\n"); return 0;}
  char *args1=
# 86 "src/monitor/sdb/sdb.c" 3 4
             ((void *)0)
# 86 "src/monitor/sdb/sdb.c"
                 ,*args2=
# 86 "src/monitor/sdb/sdb.c" 3 4
                         ((void *)0)
# 86 "src/monitor/sdb/sdb.c"
  ...
  vaddr_t addr;
  args1=strtok(
# 90 "src/monitor/sdb/sdb.c" 3 4
              ((void *)0)
# 90 "src/monitor/sdb/sdb.c"
                  ," ");
  args2=strtok(
# 91 "src/monitor/sdb/sdb.c" 3 4
              ((void *)0)
# 91 "src/monitor/sdb/sdb.c"
                  ," ");
  if(args1==
# 92 "src/monitor/sdb/sdb.c" 3 4
           ((void *)0)
# 92 "src/monitor/sdb/sdb.c"
               ){printf("Please enter the number N to be printed\n");return 0;}
  if(args2==
# 93 "src/monitor/sdb/sdb.c" 3 4
           ((void *)0)
# 93 "src/monitor/sdb/sdb.c"
               ){printf("Please enter the address or EXPR\n");return 0;}
...
static int cmd_p(char *args){
  if(args==
# 112 "src/monitor/sdb/sdb.c" 3 4
          ((void *)0)
# 112 "src/monitor/sdb/sdb.c"
              ) {printf("Please enter your expression\n");return 0;}
  
# 113 "src/monitor/sdb/sdb.c" 3 4
 _Bool 
# 113 "src/monitor/sdb/sdb.c"
      success= 
# 113 "src/monitor/sdb/sdb.c" 3 4
               1
# 113 "src/monitor/sdb/sdb.c"
...
static int cmd_w(char *args){
  if(args==
# 125 "src/monitor/sdb/sdb.c" 3 4
          ((void *)0)
# 125 "src/monitor/sdb/sdb.c"
              ) {printf("Please enter the expression you want to monitor\n");return 0;}
  
# 126 "src/monitor/sdb/sdb.c" 3 4
 _Bool 
# 126 "src/monitor/sdb/sdb.c"
      success=
# 126 "src/monitor/sdb/sdb.c" 3 4
              1
# 126 "src/monitor/sdb/sdb.c"
...
# 140 "src/monitor/sdb/sdb.c"
              ) printf("Please enter the serial number you want to delete or enter (d all) to delete all watchpoints\n");
  else{
  wp_remove(args);
  }
     return 0;
...
static int cmd_help(char *args) {
  ...
  char *arg = strtok(
# 173 "src/monitor/sdb/sdb.c" 3 4
                    ((void *)0)
# 173 "src/monitor/sdb/sdb.c"
                        , " ");
  int i;

  if (arg == 
# 176 "src/monitor/sdb/sdb.c" 3 4
            ((void *)0)
# 176 "src/monitor/sdb/sdb.c"
                ) {
...
void sdb_set_batch_mode() {
  is_batch_mode = 
# 195 "src/monitor/sdb/sdb.c" 3 4
                 1
# 195 "src/monitor/sdb/sdb.c"
                     ;
}
...
# 201 "src/monitor/sdb/sdb.c"
  ...
  if (is_batch_mode) {
    cmd_c(
# 203 "src/monitor/sdb/sdb.c" 3 4
         ((void *)0)
# 203 "src/monitor/sdb/sdb.c"
             );
    return;
  }
...
# 212 "src/monitor/sdb/sdb.c"
      ...
      if(last_cmd[0] != 0) {
        ...
        if(last_args[0] != 0)
          ...
          args = 
# 218 "src/monitor/sdb/sdb.c" 3 4
                ((void *)0)
# 218 "src/monitor/sdb/sdb.c"
                    ;
        }
        printf("last_cmd:%s\n",last_cmd);
        printf("last_args:%s\n",last_args);
      ...
      if (args >= str_end) {
        args = 
# 229 "src/monitor/sdb/sdb.c" 3 4
              ((void *)0)
# 229 "src/monitor/sdb/sdb.c"
                  ;
      }
     }
# 241 "src/monitor/sdb/sdb.c"
