...
# 19 "/home/jinghanhui/ysyx-workbench/nemu/include/memory/host.h"
...
# 20 "/home/jinghanhui/ysyx-workbench/nemu/include/memory/host.h" 2
...
# 1 "/home/jinghanhui/ysyx-workbench/nemu/include/device/mmio.h" 1
# 21 "/home/jinghanhui/ysyx-workbench/nemu/include/device/mmio.h"
...
static void out_of_bound(paddr_t addr) {
  ...
  do { if (!(0)) { (fflush(
# 61 "src/memory/paddr.c" 3 4
 stdout
# 61 "src/memory/paddr.c"
 ), fprintf(
# 61 "src/memory/paddr.c" 3 4
 stderr
# 61 "src/memory/paddr.c"
...
# 61 "src/memory/paddr.c"
 "0"
# 61 "src/memory/paddr.c" 3 4
 , "src/memory/paddr.c", 61, __extension__ __PRETTY_FUNCTION__); }))
# 61 "src/memory/paddr.c"
 ; } } while (0)
                                          ;
...
# 73 "src/memory/paddr.c" 3 4
 "x" 
# 73 "src/memory/paddr.c"
 ", " "0x%08" 
# 73 "src/memory/paddr.c" 3 4
 "x" 
# 73 "src/memory/paddr.c"
 "]" "\33[0m" "\n", "src/memory/paddr.c", 73, __func__, ((paddr_t)0x80000000), ((paddr_t)0x80000000 + 0x8000000 - 1)); do { extern FILE* log_fp; extern 
# 73 "src/memory/paddr.c" 3 4
 _Bool 
# 73 "src/memory/paddr.c"
...
# 73 "src/memory/paddr.c" 3 4
 "x" 
# 73 "src/memory/paddr.c"
 "]" "\33[0m" "\n", "src/memory/paddr.c", 73, __func__, ((paddr_t)0x80000000), ((paddr_t)0x80000000 + 0x8000000 - 1)); fflush(log_fp); } } while (0); } while (0);
}
