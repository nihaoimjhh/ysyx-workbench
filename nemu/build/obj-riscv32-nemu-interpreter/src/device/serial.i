...
# 37 "src/device/serial.c"
          "0"
# 37 "src/device/serial.c" 3 4
          , "src/device/serial.c", 37, __extension__ __PRETTY_FUNCTION__); }))
# 37 "src/device/serial.c"
          ; } } while (0);
      break;
...
# 39 "src/device/serial.c" 3 4
            stderr
# 39 "src/device/serial.c"
            , "\33[1;31m" "do not support offset = %d" "\33[0m" "\n", offset)); extern FILE* log_fp; fflush(log_fp); extern void assert_fail_msg(); assert_fail_msg(); 
# 39 "src/device/serial.c" 3 4
            ((void) sizeof ((
# 39 "src/device/serial.c"
            0
