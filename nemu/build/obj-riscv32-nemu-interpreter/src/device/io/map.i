...
# 19 "/home/jinghanhui/ysyx-workbench/nemu/src/isa/riscv32/include/isa-def.h"
...
# 20 "/home/jinghanhui/ysyx-workbench/nemu/src/isa/riscv32/include/isa-def.h" 2
...
# 1 "/home/jinghanhui/ysyx-workbench/nemu/include/memory/host.h" 1
# 21 "/home/jinghanhui/ysyx-workbench/nemu/include/memory/host.h"
static inline word_t host_read(void *addr, int len) {
  switch (len) {
    ...
    ;
    default: 
# 27 "/home/jinghanhui/ysyx-workbench/nemu/include/memory/host.h" 3 4
            ((void) sizeof ((
# 27 "/home/jinghanhui/ysyx-workbench/nemu/include/memory/host.h"
            0
# 27 "/home/jinghanhui/ysyx-workbench/nemu/include/memory/host.h" 3 4
...
# 27 "/home/jinghanhui/ysyx-workbench/nemu/include/memory/host.h"
            "0"
# 27 "/home/jinghanhui/ysyx-workbench/nemu/include/memory/host.h" 3 4
            , "/home/jinghanhui/ysyx-workbench/nemu/include/memory/host.h", 27, __extension__ __PRETTY_FUNCTION__); }))
# 27 "/home/jinghanhui/ysyx-workbench/nemu/include/memory/host.h"
                                                        ;
  }
}
...
static inline void host_write(void *addr, int len, word_t data) {
  switch (len) {
    ...
    ;
    default: 
# 37 "/home/jinghanhui/ysyx-workbench/nemu/include/memory/host.h" 3 4
   ((void) sizeof ((
# 37 "/home/jinghanhui/ysyx-workbench/nemu/include/memory/host.h"
   0
# 37 "/home/jinghanhui/ysyx-workbench/nemu/include/memory/host.h" 3 4
   ) ? 1 : 0), __extension__ ({ if (
# 37 "/home/jinghanhui/ysyx-workbench/nemu/include/memory/host.h"
...
# 37 "/home/jinghanhui/ysyx-workbench/nemu/include/memory/host.h"
   "0"
# 37 "/home/jinghanhui/ysyx-workbench/nemu/include/memory/host.h" 3 4
   , "/home/jinghanhui/ysyx-workbench/nemu/include/memory/host.h", 37, __extension__ __PRETTY_FUNCTION__); }))
# 37 "/home/jinghanhui/ysyx-workbench/nemu/include/memory/host.h"
                                             ;
  }
}
...
# 1 "/home/jinghanhui/ysyx-workbench/nemu/include/device/map.h" 1
# 19 "/home/jinghanhui/ysyx-workbench/nemu/include/device/map.h"
...
# 20 "/home/jinghanhui/ysyx-workbench/nemu/include/device/map.h" 2

typedef void(*io_callback_t)(uint32_t, int, 
# 21 "/home/jinghanhui/ysyx-workbench/nemu/include/device/map.h" 3 4
                                           _Bool
# 21 "/home/jinghanhui/ysyx-workbench/nemu/include/device/map.h"
                                               );
...
static inline 
# 33 "/home/jinghanhui/ysyx-workbench/nemu/include/device/map.h" 3 4
             _Bool 
# 33 "/home/jinghanhui/ysyx-workbench/nemu/include/device/map.h"
...
# 53 "src/device/io/map.c" 3 4
 ((void) sizeof ((
# 53 "src/device/io/map.c"
...
# 53 "src/device/io/map.c" 3 4
 , "src/device/io/map.c", 53, __extension__ __PRETTY_FUNCTION__); }))
# 53 "src/device/io/map.c"
                                          ;
  return p;
}
...
# 59 "src/device/io/map.c"
   "map != ((void *)0)"
# 59 "src/device/io/map.c" 3 4
   , "src/device/io/map.c", 59, __extension__ __PRETTY_FUNCTION__); }))
# 59 "src/device/io/map.c"
   ; } } while (0);
  } else {
    do { if (!(addr <= map->high && addr >= map->low)) { (fflush(
# 61 "src/device/io/map.c" 3 4
   stdout
# 61 "src/device/io/map.c"
   ), fprintf(
# 61 "src/device/io/map.c" 3 4
   stderr
# 61 "src/device/io/map.c"
...
# 61 "src/device/io/map.c"
   "addr <= map->high && addr >= map->low"
# 61 "src/device/io/map.c" 3 4
   , "src/device/io/map.c", 61, __extension__ __PRETTY_FUNCTION__); }))
# 61 "src/device/io/map.c"
   ; } } while (0)
...
# 67 "src/device/io/map.c" 3 4
                                                                     _Bool 
# 67 "src/device/io/map.c"
                                                                          is_write) {
  if (c != 
...
# 73 "src/device/io/map.c"
 "io_space"
# 73 "src/device/io/map.c" 3 4
 , "src/device/io/map.c", 73, __extension__ __PRETTY_FUNCTION__); }))
# 73 "src/device/io/map.c"
                 ;
  p_space = io_space;
}
...
# 78 "src/device/io/map.c" 3 4
 ((void) sizeof ((
# 78 "src/device/io/map.c"
 len >= 1 && len <= 8
# 78 "src/device/io/map.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 78 "src/device/io/map.c"
...
# 78 "src/device/io/map.c"
 "len >= 1 && len <= 8"
# 78 "src/device/io/map.c" 3 4
 , "src/device/io/map.c", 78, __extension__ __PRETTY_FUNCTION__); }))
# 78 "src/device/io/map.c"
                             ;
...
# 81 "src/device/io/map.c"
  ...
  device_read_logbuf_write(addr, len, ret, map->name); device_read_logbuf_print();
...
# 90 "src/device/io/map.c"
  ...
  device_write_logbuf_write(addr, len, data, map->name); device_write_logbuf_print();

  invoke_callback(map->callback, offset, len, 
# 97 "src/device/io/map.c" 3 4
                                             1
# 97 "src/device/io/map.c"
                                                 );
}
