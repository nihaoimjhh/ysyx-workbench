...
# 30 "src/device/io/port-io.c" 3 4
 "x" 
# 30 "src/device/io/port-io.c"
 "]" "\33[0m" "\n", "src/device/io/port-io.c", 30, __func__, maps[nr_map].name, maps[nr_map].low, maps[nr_map].high); do { extern FILE* log_fp; extern 
# 30 "src/device/io/port-io.c" 3 4
 _Bool 
# 30 "src/device/io/port-io.c"
 log_enable(); if (log_enable()) { fprintf(log_fp, "\33[1;34m" "[%s:%d %s] " "Add port-io map '%s' at [" "0x%08" 
# 30 "src/device/io/port-io.c" 3 4
 "x" 
# 30 "src/device/io/port-io.c"
 ", " "0x%08" 
