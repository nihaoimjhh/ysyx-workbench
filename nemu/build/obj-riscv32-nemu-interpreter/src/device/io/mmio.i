...
# 19 "/home/jinghanhui/ysyx-workbench/nemu/include/cpu/difftest.h"
...
# 20 "/home/jinghanhui/ysyx-workbench/nemu/include/cpu/difftest.h" 2
...
# 31 "src/device/io/mmio.c" 3 4
 "x" 
# 31 "src/device/io/mmio.c"
 "]" "\33[0m" "\n", name1, l1, r1, name2, l2, r2)); extern FILE* log_fp; fflush(log_fp); extern void assert_fail_msg(); assert_fail_msg(); 
# 31 "src/device/io/mmio.c" 3 4
 ((void) sizeof ((
# 31 "src/device/io/mmio.c"
 0
...
# 37 "src/device/io/mmio.c"
  ...
  do { printf("\33[1;34m" "[%s:%d %s] " "Add mmio map '%s' at [" "0x%08" 
...
# 50 "src/device/io/mmio.c" 3 4
 "x" 
# 50 "src/device/io/mmio.c"
 "]" "\33[0m" "\n", "src/device/io/mmio.c", 50, __func__, maps[nr_map].name, maps[nr_map].low, maps[nr_map].high); do { extern FILE* log_fp; extern 
# 50 "src/device/io/mmio.c" 3 4
 _Bool 
# 50 "src/device/io/mmio.c"
 log_enable(); if (log_enable()) { fprintf(log_fp, "\33[1;34m" "[%s:%d %s] " "Add mmio map '%s' at [" "0x%08" 
# 50 "src/device/io/mmio.c" 3 4
 "x" 
# 50 "src/device/io/mmio.c"
 ", " "0x%08" 
