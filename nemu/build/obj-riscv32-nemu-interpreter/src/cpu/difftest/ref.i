...
# 21 "src/cpu/difftest/ref.c"
  ...
  if(direction == DIFFTEST_TO_REF) {
    ...
    printf("difftest_memcpy: unhandled direction\n");
    
# 27 "src/cpu/difftest/ref.c" 3 4
   ((void) sizeof ((
# 27 "src/cpu/difftest/ref.c"
   0
# 27 "src/cpu/difftest/ref.c" 3 4
...
# 27 "src/cpu/difftest/ref.c"
   "0"
# 27 "src/cpu/difftest/ref.c" 3 4
   , "src/cpu/difftest/ref.c", 27, __extension__ __PRETTY_FUNCTION__); }))
# 27 "src/cpu/difftest/ref.c"
            ;
  }
}
...
# 31 "src/cpu/difftest/ref.c" 3 4
                                        _Bool 
# 31 "src/cpu/difftest/ref.c"
                                             direction) {
  if(direction == DIFFTEST_TO_REF) {
...
# 45 "src/cpu/difftest/ref.c" 3 4
 ((void) sizeof ((
# 45 "src/cpu/difftest/ref.c"
 0
# 45 "src/cpu/difftest/ref.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 45 "src/cpu/difftest/ref.c"
...
# 45 "src/cpu/difftest/ref.c"
 "0"
# 45 "src/cpu/difftest/ref.c" 3 4
 , "src/cpu/difftest/ref.c", 45, __extension__ __PRETTY_FUNCTION__); }))
# 45 "src/cpu/difftest/ref.c"
          ;
}
